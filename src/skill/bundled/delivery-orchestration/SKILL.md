...
- Do not sink substantial time or cost into something expensive or hard to undo while a material decision is still an unconfirmed guess; align it first, in one card (step 2).
