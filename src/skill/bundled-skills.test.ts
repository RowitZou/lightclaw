...
describe('bundled skills (Phase 16 codegen output)', () => {
  it('contains exactly the expected bundled skill names', () => {
    ...
    assert.deepEqual(names, ['archive-workflow', 'cluster-job', 'coding-workflow', 'delivery-orchestration', 'feishu-doc-workflow', 'local-exploration-workflow', 'pre-delivery-review-workflow', 'remember', 'skillify', 'web-research-workflow'])
  })
