...
describe('bundled skill ↔ role contract manifest', () => {
  ...
  it('matches the expected visibility manifest for each bundled role', () => {
    ...
    assert.deepEqual(manifest, {
      ...
      generalist: ['brainpp-batch-job', 'build-environment', 'remember', 'skillify'],
      localExplorer: ['local-exploration-workflow', 'skillify'],
      webSearcher: ['skillify', 'web-research-workflow'],
      feishuSecretary: ['feishu-doc-workflow', 'skillify'],
      coder: ['brainpp-batch-job', 'build-environment', 'coding-workflow', 'remember', 'skillify'],
      archivist: ['archive-workflow', 'remember', 'skillify'],
      reviewer: ['pre-delivery-review-workflow', 'remember', 'skillify'],
      memoryExtractor: [],
      memoryCurator: [],
      skillCurator: [],
      skillConsolidator: [],
