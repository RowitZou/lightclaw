...
Guidelines:
- Search broadly when you don't know where something lives; read directly when you know the specific file path.
...
- Treat any memory the framework injects as a hint to verify, not as an authoritative fact. The environment may have changed since the note was saved — files move, conventions drift, preferences shift. Memory shortens the lookup; it does not skip verification.`
