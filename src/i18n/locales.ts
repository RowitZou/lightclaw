...
export const LOCALES = {
  cn: {
    ...
    'card.endpoint.param.authPath': '`--auth-path <凭证文件>` — Codex 凭证文件路径；仅 `--type codex` 时使用',
    'card.endpoint.note.codexAuth': 'Codex 凭证文件由 `codex login` 生成，默认在 `~/.codex/auth.json`。',
  ...
  en: {
    ...
    'card.endpoint.param.authPath': '`--auth-path <auth-file>` — Codex credential file path; only with `--type codex`',
    'card.endpoint.note.codexAuth': 'The Codex credential file is created by `codex login`, default `~/.codex/auth.json`.',
