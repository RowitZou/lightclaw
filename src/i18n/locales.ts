...
export const LOCALES = {
  cn: {
    ...
    'config.endpoint.probeOk': '已接通，可用模型：{list}',
    'config.endpoint.probeOkMore': '已接通，可用模型（显示前 {count} 个，更多请查阅模型服务商）：{list}',
    ...
    'config.endpoint.nextStep': '下一步：用 /config backend add <模型名> --endpoint {name} --upstream <上面的某个模型 id> 把模型接入可用列表。',
  ...
  en: {
    ...
    'config.endpoint.probeOk': 'Connected. Available models: {list}',
    'config.endpoint.probeOkMore': 'Connected. Available models (showing first {count}; see your model provider for the rest): {list}',
    ...
    'config.endpoint.nextStep': 'Next: run /config backend add <model-name> --endpoint {name} --upstream <one of the ids above> to add a usable model.',
