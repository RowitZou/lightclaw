...
export const LOCALES = {
  cn: {
    ...
    'config.model.schemaInvalid': '错误：schema 必须是 anthropic 或 openai（openai-auth 当前尚不支持）。',
  ...
  en: {
    ...
    'config.model.schemaInvalid': 'Error: schema must be anthropic or openai (openai-auth is not yet supported).',
