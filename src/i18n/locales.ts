...
export const LOCALES = {
  cn: {
    ...
    'cmd.config.usage': '/config <model|mode|lang|rule|workspace|endpoint|...> [verb] [args]',
    ...
    'config.usage': [
      ...
      '  /config endpoint | model | codex ...     自带模型（BYO）配置',
    ].join('\n'),
    ...
    'config.endpoint.codexAuthMissing': '错误：尚未导入 Codex 凭据 "{name}"。请先运行 /config codex import。',
  ...
  en: {
    ...
    'config.usage': [
      ...
      '  /config endpoint | model | codex ...     bring-your-own (BYO) config',
    ].join('\n'),
    ...
    'config.endpoint.codexAuthMissing': 'Error: Codex credentials "{name}" are not imported. Run /config codex import first.',
