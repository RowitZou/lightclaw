...
export const LOCALES = {
  cn: {
    ...
    'user.usage.approveLocal': '  /user approve <code>',
    'user.usage.approveGeneric': '  /user approve <code>',
    ...
    'user.approve.usage': '用法：/user approve <code>',
    ...
    'channel.pairing.adminCmd': '管理员命令：`/user approve {code}`',
    ...
    'channel.pairing.waiting.body': '申请已提交。管理员将通过飞书卡片审批；如管理员暂时不在飞书，可在终端使用 `/user approve {code}`。',
  ...
  en: {
    ...
    'user.pending.header': 'KEY      CHANNEL  PEER_ID                                  DISPLAY          REQUESTED',
    'user.approve.usage': 'Usage: /user approve <code>',
    ...
    'channel.pairing.adminCmd': 'Admin command: `/user approve {code}`',
    ...
    'channel.pairing.waiting.body': 'Submitted. Admin will approve via Feishu card; or via terminal `/user approve {code}` if admin is offline.',
