...
export const LOCALES = {
  cn: {
    ...
    'help.usageHint': '查看某个命令的详细用法：/help <command>，例如 /help model。',
    'help.detailTitle': '{name} 帮助',
    'help.detailUsage': '用法：',
    'help.detailSubcommands': '子命令 / 示例：',
    'help.detailVisibility': '可见性：{visibility}',
    'help.visibility.all': '所有用户',
    'help.visibility.admin': '仅 admin',
    'help.visibility.user': '仅普通用户',
    'help.unknownCommand': '未知命令：{name}。输入 /help 查看可用命令。',

    // ---- Command descriptions (rendered in /help) ----
    // /help shows the command name + this one-line description; detailed
    // usage is available through /help <command>. Keep each desc to a single
    // short line.
    ...
    'cmd.user.usage': '/user list|pending|approve|reject|unlink|remove|set-home|clear-home|home-requests|approve-home|reject-home|feedback',
    ...
    'cmd.auth.usage': '/auth codex ... | /auth list | import codex | logout codex [--purge]',
    'cmd.auth.desc': '管理用户 Codex authRef 或 admin 全局 OAuth 凭证',
    'cmd.config.usage': '/config [show|reset|set-home]',
    'cmd.config.desc': '管理当前用户配置',
    'cmd.skill.usage': '/skill [list|view <name>|delete <name>]',
    'cmd.skill.desc': '查看或删除当前用户的 skill',
    ...
    'channel.failure.credentialHint': '建议：需要管理员导入或刷新模型凭证（如 `/auth import codex`）后重试；重发同一条消息无法解决。',
    ...
    'taskcard.footer.updated': '更新于 {time} · 任务 #{id}',
    'taskcard.footer.finished': '结束于 {time} · 任务 #{id}',
    ...
    'channel.welcome.intro': '管理员已批准你的接入，可以开始对话了。',
    ...
    'secret.savedBrainpp': '密钥 {name} 已保存（replaced={replaced}，length={length}）。BrainppCluster 会直接读取这个密钥，无需额外启用步骤。',
  ...
  en: {
    ...
    'help.usageHint': 'For detailed command usage: /help <command>, for example /help model.',
    'help.detailTitle': '{name} help',
    'help.detailUsage': 'Usage:',
    'help.detailSubcommands': 'Subcommands / examples:',
    'help.detailVisibility': 'Visibility: {visibility}',
    'help.visibility.all': 'all users',
    'help.visibility.admin': 'admin only',
    'help.visibility.user': 'non-admin users only',
    'help.unknownCommand': 'Unknown command: {name}. Type /help for the command list.',
    ...
    'cmd.auth.usage': '/auth codex ... | /auth list | import codex | logout codex [--purge]',
    'cmd.auth.desc': 'Manage user Codex authRefs or admin global OAuth credentials',
    'cmd.config.usage': '/config [show|reset|set-home]',
    'cmd.config.desc': 'Manage current user config',
    'cmd.skill.usage': '/skill [list|view <name>|delete <name>]',
    'cmd.skill.desc': 'View or delete current user skills',
    ...
    'channel.failure.credentialHint': 'Suggestion: an admin must import or refresh the model credentials (e.g. `/auth import codex`) and then retry; resending the same message will not help.',
    ...
    'taskcard.footer.updated': 'Updated {time} · task #{id}',
    'taskcard.footer.finished': 'Ended {time} · task #{id}',
    ...
    'channel.welcome.intro': 'Admin has approved your access. You can start chatting now.',
    ...
    'secret.savedBrainpp': 'Secret {name} saved (replaced={replaced}, length={length}). BrainppCluster reads this secret directly; no extra enable step is needed.',
