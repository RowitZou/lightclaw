...
export const LOCALES = {
  cn: {
    ...
    'admin.list.mount': '审批或撤销用户的读写挂载',
    'admin.mount.usage': '用法：/admin mount list [user] | approve <user> <path|fileset> | revoke <user> <path|fileset>',
    'admin.mount.list.empty': '没有待审批或已批准的读写挂载。',
    'admin.mount.list.pending': '- [待审批] {user} · {fileset} · {path}',
    'admin.mount.list.approved': '- [已批准] {user} · {fileset}',
    'admin.mount.approved': '已批准 {user} 对 {fileset} 的读写挂载；worker：{worker}',
    'admin.mount.revoked': '已撤销 {user} 对 {fileset} 的读写挂载；现有挂载已降为只读；worker：{worker}',
    ...
    'mount.mode.mixed': '混合',
    'mount.ro.auto': '只读挂载已自动授权，并由沙箱内核强制只读。',
    'mount.rw.pendingApproval': '读写请求正在等待管理员批准；当前仅按只读挂载：{paths}',
    'mount.denied.notMounted': '服务身份无法挂载该路径。',
    'mount.denied.readOnly': '服务身份对该 fileset 只有只读权限，无法批准读写。',
  ...
  en: {
    ...
    'admin.list.mount': 'Approve or revoke user read-write mounts',
    'admin.mount.usage': 'Usage: /admin mount list [user] | approve <user> <path|fileset> | revoke <user> <path|fileset>',
    'admin.mount.list.empty': 'No pending or approved read-write mounts.',
    'admin.mount.list.pending': '- [pending] {user} · {fileset} · {path}',
    'admin.mount.list.approved': '- [approved] {user} · {fileset}',
    'admin.mount.approved': 'Approved read-write mount for {user} on {fileset}; worker: {worker}',
    'admin.mount.revoked': 'Revoked read-write mount for {user} on {fileset}; existing mounts were downgraded to read-only; worker: {worker}',
    // ---- L2 card: /admin nouns (batches 4-6) ----
    ...
    'mount.ro.auto': 'Read-only mount was authorized automatically and is enforced read-only by the sandbox kernel.',
    'mount.rw.pendingApproval': 'Read-write access is pending admin approval; mounted read-only for now: {paths}',
    'mount.denied.notMounted': 'The service identity cannot mount this path.',
    'mount.denied.readOnly': 'The service identity only has read-only access to this fileset; read-write cannot be approved.',
