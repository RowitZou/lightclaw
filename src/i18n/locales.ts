...
export const LOCALES = {
  cn: {
    ...
    'sandbox.localActive': '  （local runtime 激活；就绪追踪不适用）',
  ...
  en: {
    ...
    // ---- /sandbox ----
    'sandbox.title': 'Sandbox image readiness:',
    'sandbox.state': '  state: {state}',
    'sandbox.image': '  image: {image}',
    ...
    'sandbox.localActive': '  (local runtime active; readiness tracker unused)',
