...
1. Note the result in a sentence or two, and (if option 2 also applies) what you decided to do about it — it lands on the task card's timeline, where the user follows progress ("the daily fetch finished — nothing unusual"; "the research came back, I'm folding it into the answer now"). Keep it brief; the user-facing conclusion is your final reply when you finish the root — written in full there, not compressed into the deliver summary.
